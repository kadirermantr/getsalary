      ...
      <div className="relative text-center">
        ...
        <p className="text-sm text-[var(--text-secondary)]">
          ...
          <a
            ...
            className="inline-flex items-baseline gap-1 text-[var(--accent)] hover:opacity-80 font-medium transition-opacity"
          >
            <svg className="w-4 h-4 self-center" fill="currentColor" viewBox="0 0 24 24">
