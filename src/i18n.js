  ...
  tr: {
    translation: {
      ...
      charts: {
        ...
        total: 'toplam',
        medianUsd: 'Medyan (USD)',
        inflationDesc: 'Yıllık maaş artışı vs TÜFE enflasyonu karşılaştırması. Kesikli çizgi USD bazlı medyan maaşı gösterir.',
      ...
      prediction: {
        ...
        chartTitle: 'Gerçekleşen vs Tahmin',
        actual: 'Gerçekleşen',
        predicted: 'Tahmin',
        confidenceBand: 'Güven Aralığı',
        median: 'Medyan Tahmin',
        modelFit: 'Tahmin Doğruluğu',
        estimatedGrowth: 'Tahmini Artış',
        avgError: 'Ortalama Hata',
        profileTitle: 'Profil',
        position: 'Pozisyon',
        experience: 'Deneyim',
        ...
        scenarioTitle: 'Senaryo Parametreleri',
        optimistic: 'İyimser',
        normal: 'Normal',
        pessimistic: 'Kötümser',
        inflation: 'Enflasyon (TÜFE)',
        exchangeRate: 'USD/TRY Değişimi',
        sectorGrowth: 'Sektör Büyümesi',
        byPosition: 'Pozisyona Göre Tahmin',
        byExperience: 'Deneyime Göre Tahmin',
        backtestTitle: 'Model Doğrulama',
        year: 'Yıl',
        errorRate: 'Sapma',
  ...
  en: {
    translation: {
      ...
      charts: {
        ...
        total: 'total',
        medianUsd: 'Median (USD)',
        inflationDesc: 'Annual salary growth vs CPI inflation comparison. Dashed line shows USD-based median salary.',
      ...
      prediction: {
        ...
        chartTitle: 'Actual vs Prediction',
        actual: 'Actual',
        predicted: 'Predicted',
        confidenceBand: 'Confidence Band',
        median: 'Median Prediction',
        modelFit: 'Prediction Accuracy',
        estimatedGrowth: 'Est. Growth',
        ...
        scenarioTitle: 'Scenario Parameters',
        optimistic: 'Optimistic',
        normal: 'Normal',
        pessimistic: 'Pessimistic',
        inflation: 'Inflation (CPI)',
        exchangeRate: 'USD/TRY Change',
        sectorGrowth: 'Sector Growth',
        byPosition: 'Prediction by Position',
        byExperience: 'Prediction by Experience',
        backtestTitle: 'Model Validation',
        year: 'Year',
        errorRate: 'Error',
